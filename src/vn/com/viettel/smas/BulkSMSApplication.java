    ...
    class BulkSMSTransaction {
        ...
        public void doWorkSchool(String node) throws ParseException {
            ...
            try {
                ...
                List<SmsMT> lstSMS = MTDAL.getSmsMt(connection, statement, rs, node, GlobalConstant.SEND_NORMAL, log);
        ...
        void processSendSMS(final SmsMT objSms) {
            KThreadPoolExecutor.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    String sms = StringUtil.removeSpecialChar(objSms.getSMS_CONTENT().trim());
